...
import pathlib, re, sys, random, collections
...
STOP = set("""The He She It They And But Then When Now His Her A An In On At As So There That This
What You We If For Of To With Was Were Had Has Said Like Up Down Out Into Over Under Their
Its Him Them Not No Yes Maybe Just Only Still Even Once Twice Three One Two Some All Each
Every More Most Less Than Then Here Where Why How Who Which While After Before About Above
Below Across Behind Beside Between Beyond During Through Without Within Around Against Off
I'd He'd She'd It's He's She's They'd We'd You'd Don't Didn't Couldn't Wouldn't""".split())
